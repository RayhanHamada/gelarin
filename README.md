...
gelarin/0.7.0 win32-x64 node-v14.3.0
...
_See code: [src\commands\new.ts](https://github.com/RayhanHamada/gelarin/blob/v0.7.0/src\commands\new.ts)_
...
_See code: [src\commands\rm.ts](https://github.com/RayhanHamada/gelarin/blob/v0.7.0/src\commands\rm.ts)_
...
_See code: [src\commands\use.ts](https://github.com/RayhanHamada/gelarin/blob/v0.7.0/src\commands\use.ts)_
<!-- commandsstop -->
* [`gelarin help [COMMAND]`](#gelarin-help-command)
* [`gelarin new [REPOLINK] [DESCRIPTION]`](#gelarin-new-repolink-description)
* [`gelarin rm [NAME]`](#gelarin-rm-name)
